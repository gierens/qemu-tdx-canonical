...
#define DEFINE_CCW_MACHINE_NAMED(qemuver, suffix, verstr, latest)             \
    ...
    {                                                                         \
        ...
        mc->desc = "Virtual s390x machine - " verstr;                         \
        if (latest) {                                                         \
...
DEFINE_CCW_MACHINE_NAMED(6_2, ubuntu_kinetic, "kinetic", false);
DEFINE_CCW_MACHINE_NAMED(7_2, ubuntu_lunar, "lunar", false);
DEFINE_CCW_MACHINE_NAMED(8_0, ubuntu_mantic, "mantic", false);
DEFINE_CCW_MACHINE_NAMED(8_2, ubuntu_noble, "noble", false);
DEFINE_CCW_MACHINE_NAMED(9_0, ubuntu_oracular, "oracular", true);
